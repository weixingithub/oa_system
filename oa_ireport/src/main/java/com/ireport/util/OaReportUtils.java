...
public class OaReportUtils {  
     ...
     * @param request 
     */  
    public OaReportUtils(HttpServletRequest request) {  
        this.request = request;  
        this.session = request.getSession();  
    }  
    public OaReportUtils(HttpServletRequest request, HttpServletResponse response) {  
        this(request);  
