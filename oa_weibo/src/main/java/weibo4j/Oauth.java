...
public class Oauth extends Weibo {
	...
	public AccessToken getAccessTokenByCode(String code,String client_ID,String client_SERCRET,String redirect_URI) throws WeiboException {
		return new AccessToken(client.post(
				...
				new PostParameter[] {
						...
						new PostParameter("redirect_uri", redirect_URI) }, false, null));
	}

	public String authorize(String response_type,String client_ID,String redirect_URI) throws WeiboException {
		return WeiboConfig.getValue("authorizeURL").trim() + "?client_id=" + client_ID.trim() + "&redirect_uri="+redirect_URI.trim()
				+ "&response_type=" + response_type;
	}

	public String authorize(String response_type, String state,String client_ID,String redirect_URI)
	...
	public String authorize(String response_type, String state, String scope,String client_ID,String redirect_URI)
			throws WeiboException {
		return WeiboConfig.getValue("authorizeURL").trim() + "?client_id="
				+ client_ID.trim() + "&redirect_uri=" + redirect_URI.trim()
				+ "&response_type=" + response_type + "&state=" + state
