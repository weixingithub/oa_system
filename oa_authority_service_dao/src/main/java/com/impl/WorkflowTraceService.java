...
import com.tool.util.WorkflowUtils;
...
public class WorkflowTraceService {
     ...
     * @return 封装了各种节点信息
     */
    public List<Map<String, Object>> traceProcess(String processInstanceId,String modelId) throws Exception {
        ...
        for (ActivityImpl activity : activitiList) {
            ...
            Map<String, Object> activityImageInfo = packageSingleActivitiInfo(activity, processInstance, currentActiviti,modelId);
    ...
    private Map<String, Object> packageSingleActivitiInfo(ActivityImpl activity, ProcessInstance processInstance,
                                                          boolean currentActiviti,String modelId) throws Exception {
    ...
    private void setTaskGroup(Map<String, Object> vars, OaRole oaRole) {
        String roles = "";
        roles += oaRole.getRoleName();
